...
st.markdowan("# :red[💪 คำนวณค่าดัชนีมวลกาย BMI]")
...
height = st.number_input("กรอกส่วนสูงของคุณ (เซนติเมตร):",min_value=1.0, value=1.0)

#ส่วนที่ 3 สร้างปุ่มกดค่านวณ 
if st.button("คำนวณค่า bmi"): 
   # แปลงส่วนสูงจาก cm เป็น เมตร แล้วค่านวณ BML
...
#ส่วนที่ 4 แปลผลค่า BMI ตามเกณฑ์
  if bmi < 18.5:
     ...
     st.info("💡 คุณเริ่มมีน้ำหนักอยู่ในเกณฑ์ (ท้วม)")
  else:
    st.error("🚨 คุณอยุ่ในเกณฑ์อ้วน ควรระวังเรื่องสุขภาพและออกกำลังกาย")

st.divider()
st.write("นางสาวกานต์ปภา เฮ้าวัน เลขที่12  ม.4/14")
